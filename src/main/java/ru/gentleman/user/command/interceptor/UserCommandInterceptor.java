...
public class UserCommandInterceptor  implements MessageDispatchInterceptor<CommandMessage<?>>  {
    ...
    public BiFunction<Integer, CommandMessage<?>, CommandMessage<?>> handle(@Nonnull List<? extends CommandMessage<?>> messages) {
        return (index, command) -> {
            if(CreateUserCommand.class.equals(command.getPayload())) {
            ...
            } else if (UpdateUserCommand.class.equals(command.getPayload())) {
            ...
            }  else if (DeleteUserCommand.class.equals(command.getPayload())) {
